          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                At ClimateWise, we are committed to protecting your privacy and ensuring transparency 
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-2 text-gray-600">
                  <p><strong>Email:</strong> privacy@climatewise.ai</p>
                  <p><strong>Contact Form:</strong> <a href="/contact" className="text-blue-600 hover:underline">climatewise.ai/contact</a></p>
                </div>
              </div>
            </section>
