...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const emailBody = `Hi ClimateWise Team,
...
---
Sent via ClimateWise Contact Form`;

    // Create mailto URL
    const mailtoUrl = `mailto:info@climatewise.ai?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(emailBody)}`;
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Have questions about ClimateWise? Need support or want to share feedback? 
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@climatewise.ai</p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900">Is ClimateWise free to use?</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Can I use ClimateWise for my business?</h4>
