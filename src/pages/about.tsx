      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            About <span className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">ClimateWise</span>
          </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  ...
                  ClimateWise bridges this gap by providing real-time environmental data, personalized risk 
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <p className="text-lg text-gray-600 text-center leading-relaxed">
              ClimateWise is built by a passionate team of climate scientists, AI engineers, and environmental advocates 
        ...
        <section className="text-center">
          <div className="bg-gray-100 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Help us build a more climate-resilient world. Start using ClimateWise today and become 
